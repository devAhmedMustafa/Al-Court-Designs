...
namespace OrdrMate.Data.Migrations
{
    ...
    [Migration("20250519153003_RestaurantToManager")]
    partial class RestaurantToManager
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrdrMate.Models.Restaurant", b =>
                {
                    ...
                    b.HasOne("OrdrMate.Models.Manager", null)
                        .WithOne("Restaurant")
                        .HasForeignKey("OrdrMate.Models.Restaurant", "ManagerId1");
